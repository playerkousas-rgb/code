...
const semaphoreAngles = {
    // 第一排 (A-G: 其中一支手固定在 0° 正下方)
    'A': [0, 45],    // 右手下，左手斜下
    'B': [0, 90],    // 右手下，左手平橫
    'C': [0, 135],   // 右手下，左手斜上
    'D': [0, 180],   // 右手下，左手直上
    'E': [0, 225],   // 右手下，右手斜上 (跨身體) -> 修正：左手下，右手斜上
    'F': [0, 270],   // 左手下，右手平橫
    'G': [0, 315],   // 左手下，右手斜下

    // 第二排 (H-N: 其中一支手固定在 45° 左斜下)
    'H': [45, 90],   
    'I': [45, 135],  
    'J': [270, 180], // 特殊：右手平橫，左手直上 (與圖相符)
    'K': [45, 180],  
    'L': [45, 225],  
    'M': [45, 270],  
    'N': [45, 315],  
    ...
    // 特殊功能符號 (對應圖中最後一行)
    '!': [45, 315],  // Error: 雙手斜下交叉擺動 (起始位)
    '@': [135, 225], // End/Finish: 雙手斜上
    '#': [270, 180], // Numeral: 同 J
    '$': [45, 90],   // Attention: 同 H (持續擺動)
    '%': [0, 0]      // Rest: 雙手重疊在下方
};
