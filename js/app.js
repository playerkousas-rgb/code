...
// 嚴格對照 semaphore_exercise (3).jpg 校正
// 角度說明：0=上, 45=右上, 90=右, 135=右下, 180=下, 225=左下, 270=左, 315=左上
const semaphoreAngles = {
    'A': [180, 225], 'B': [180, 270], 'C': [180, 315], 'D': [180, 0],
    'E': [180, 45],  'F': [180, 90],  'G': [180, 135], 'H': [270, 225],
    'I': [270, 315], 'J': [0, 90],    'K': [0, 225],   'L': [0, 270],
    'M': [0, 315],   'N': [0, 45],    'O': [315, 270], 'P': [0, 270], 
    'Q': [45, 270],  'R': [90, 270],  'S': [135, 270], 'T': [0, 315],
    'U': [45, 315],  'V': [90, 0],    'W': [45, 90],   'X': [45, 135],
    'Y': [90, 315],  'Z': [90, 45],
    // 特殊符號對照 PNG 底部動作
    '!': [225, 135], // Error (雙手斜下)
    '@': [315, 45],  // AR (雙手斜上)
    '#': [0, 90],    // Numeral (同 J)
    '$': [270, 225], // Attention (同 H)
    '%': [315, 45]   // Numbers (同 @)
};
