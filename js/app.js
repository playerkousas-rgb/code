...
// ===================== 嚴格校對版：旗語角度數據 =====================
// 0: 正上, 45: 右上, 90: 正右, 135: 右下, 180: 正下, 225: 左下, 270: 正左, 315: 左上
const semaphoreAngles = {
    'A': [180, 135], 'B': [180, 90],  'C': [180, 45],  'D': [180, 0],
    'E': [180, 315], 'F': [180, 270], 'G': [180, 225], 'H': [135, 90],
    'I': [135, 45],  'J': [270, 0],    'K': [135, 0],   'L': [135, 315],
    'M': [135, 270], 'N': [135, 225], 'O': [90, 45],   'P': [90, 0],
    'Q': [90, 315],  'R': [90, 270],  'S': [90, 225],  'T': [45, 0],
    'U': [45, 315],  'V': [270, 225], 'W': [45, 270],  'X': [45, 225],
    'Y': [0, 315],   'Z': [315, 270],
    // 特殊符號 (對應你的 !@#$% 按鈕)
    '!': [225, 135], // Error (雙手斜下交叉)
    '@': [225, 45],  // End (AR 訊號)
    '#': [270, 0],    // Answering (同 J)
    '$': [225, 270], // Attention (同 H)
    '%': [225, 45]   // Numerical (數字號)
};
