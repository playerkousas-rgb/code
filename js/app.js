...
const semaphoreAngles = { 
    ...
    'Y': [315, 90], 'Z': [135, 90],
   '!': [45, 180],  // 1. Error: 圖片左一，黃手(右手)斜上 45°，藍手下垂 180° (準備揮動)
    '@': [180, 180], // 2. End: 圖片左二，雙手向下併攏
    '#': [180, 45],  // 3. Answering: 圖片中間，黃手下垂 180°，藍手(左手)斜上 45°
    '$': [135, 45],  // 4. Attention: 圖片右二，雙手斜上 V 字 (黃左上 135°，藍右上 45°)
    '%': [135, 0]    // 5. Numerical: 圖片右一，黃手左上 135°，藍手直上 0°
};
