...
// 最終精確校正版：完全對應 PNG 真人動作
const semaphoreAngles = {
    'A': [0, 45],    'B': [0, 90],    'C': [0, 135],   'D': [0, 180],
    'E': [0, 225],   'F': [0, 270],   'G': [0, 315],   'H': [45, 90],
    'I': [45, 135],  'J': [270, 180], 'K': [45, 180],  'L': [45, 225],
    'M': [45, 270],  'N': [45, 315],  'O': [90, 135],  'P': [90, 180],
    'Q': [90, 225],  'R': [90, 270],  'S': [90, 315],  'T': [135, 180],
    'U': [135, 225], 'V': [90, 315],  'W': [270, 225], 'X': [270, 135],
    'Y': [135, 270], 'Z': [225, 270],
    // 特殊符號
    '!': [315, 45],  // Error (雙手斜下)
    '@': [135, 225], // End (雙手斜上)
